<?php get_header() ?>
	<section class="w-full m-auto box box--even">
		<div class="w-full m-auto lg:max-w-screen-xxl px-4 md:px-8 lg:px-80 py-[60px] lg:py-20 text-center">
			...
			<h1 class="text-[color:var(--Preto-Cinza,#222)] text-center md:text-5xl not-italic font-semibold md:leading-[125%] tracking-[-0.96px] text-[#222222] text-[26px] leading-loose my-4"><?php echo get_the_archive_description(); ?></h1>
		</div>
	</section>
	<section class="w-full m-auto box box--odd">
		<div class="w-full m-auto lg:max-w-screen-xxl px-6 md:px-8 xl:px-32 py-8 xl:py-20 text-left">
			<?php if (have_posts()): ?>
